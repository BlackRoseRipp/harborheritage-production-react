      ...
      <section className="max-w-screen-xl w-full mx-auto px-2 lg:py-24 py-16">
        ...
        <div className="flex flex-col gap-8">
          ...
          <p className="text-wall">
            ...
            <strong>January to December</strong> and then{" "}
            <strong>June to May</strong> annually) that couples the lectures and
            lessons in Gender and Human Rights, three (3) virtual Fellowship
            program, a six-week internship and a final Cumulative Research Paper
            ...
            <br />
            <br />
            Successful completion of this program comes with a heat sealed,
            mailed diploma.
            <br />
            <br />
            <strong>
