  ...
  return (
    <Fragment>
      <section className="relative w-full overflow-x-hidden">
        <div className="bg-[url(../public/img/md-duran-1VqHRwxcCCw-unsplash.jpg)] bg-cover 2xl:bg-[center_top_-10rem] bg-center bg-no-repeat w-full banner lg:before:border-t-[6.25rem] md:before:border-t-[4rem] lg:after:border-t-[6.25rem] md:after:border-t-[4rem]">
      ...
      <section className="max-w-screen-xl w-full mx-auto px-2 lg:py-24 py-16">
        <img
          ...
          src="/img/logos/master-of-arts-logo.png"
        ...
        <div className="flex flex-col gap-8">
          ...
          <p className="text-wall">
            <u>OVERVIEW</u>: <br />
            Our Master of Arts Program is intended to be used as an
            <strong>Academic Degree</strong>
            for career advancement as an Senior-Level professional in Gender and
            Human Rights (G/HR) Advocacy. <br />
            <br />
            Specifically designed for the: <br />
            <br />
            1. <strong>Professional Changing Careers</strong> that is looking
            for a promotion or lateral career move. <br />
            ...
            3.{" "}
            <strong>
              Educators looking to transition to Professorships
            </strong>{" "}
            and seeking a greater career that can help them transition into
            ...
            <u>
              <strong>USD$12,000.00</strong>
            </u>{" "}
            per Student, via invoice. ( <strong>$11,500</strong> for the course
            and <strong>$500</strong> for Graduation Fees). Payment plans are
            offered with a <strong>USD $2,500</strong> deposit and eight (8)
            monthly payments of <strong>USD$1,187.50</strong> (no-interest
            ...
            <ul className="list-disc list-outside ml-8">
              <li>Bachelor Degree (HHU or transferred in) or</li>
              <li>
                <strong>Life/Work Experience</strong>, in Humanities, Theology,
                ...
                experience (5-9 years or more in the field) or a combination of
            ...
            (either/or) an Educational, Professional, Business or Theological
            reference, that can <u>verify</u> the prerequisites in the
            respective areas and can validate both your character and work
            ethic. The letter{" "}
            <strong>
              <u>MUST</u>
            </strong>{" "}
        ...
        <div className="mt-16 flex justify-center w-full">
          <a
            ...
            href="/pdfs/hhu_master_of_arts_syllabus_.pdf"
      ...
      <section className="max-w-screen-xl mx-auto w-full px-2 py-16 lg:py-24">
        <p className="">
          ...
          (AA, BA, or MA program), but if they <u>do not</u> finish the intended
          four-year program, they <strong>will assume full market rate</strong>{" "}
